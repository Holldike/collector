...
function generateSearchQueries() {
    return
        $inquiries = [
            'https://search.yahoo.com/search?p=' . generateNewWord() . '&fr=yfp-t&fp=1&toggle=1&cop=mss&ei=UTF-8',
            'https://www.bing.com/search?q=' . generateNewWord() . '&qs=n&form=QBLH&sp=-1&pq=1&sc=8-1&sk=&cvid=748CC6D483DE4E51BEA8836D9CDF5C70',
            'http://www.baidu.com/s?ie=utf-8&f=8&rsv_bp=1&rsv_idx=1&ch=&tn=baidu&bar=&wd=' . generateNewWord() .'&rn=&oq=&rsv_pq=ec41a0a9003d6984&rsv_t=fb51v4F3MNd4aRxgbSGtw%2B4fLUR9%2BJcWPv1frN%2BPdLEMmGtcya%2FHNxVv28c&rqlang=cn',
            'https://duckduckgo.com/?q=' . generateNewWord() . '&t=h_&ia=web',
